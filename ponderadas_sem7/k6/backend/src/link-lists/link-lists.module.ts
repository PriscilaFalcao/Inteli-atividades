...
@Module({
  ...
  providers: [LinkListsService, PrismaService, headersMatch, atLeastOneRecord, csvRecordValidName, csvRecordValidEmail, csvRecordValidPhone, csvRecordValidCpf, RabbitMQService],
